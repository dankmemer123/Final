...
public class SignUp extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usernameText = (EditText) findViewById(R.id.textView5);
        passwordText = (EditText) findViewById(R.id.textView9);
        passwordAgainText = (EditText) findViewById(R.id.textView10);
        eMailText = (EditText) findViewById(R.id.textView12);
                                ...
                                public void run() {
                                    if(usernameText != null && passwordText != null && eMailText != null) {
                                        if(!TextUtils.isEmpty(usernameText.getText()) && !TextUtils.isEmpty(passwordText.getText()) &&
                                            ...
                                            Log.e("hold up", "");// ask user to fill all required fields
                                        }
                                    }
                                    //result = imService.signUpUser(usernameText.getText().toString(),
                                           // passwordText.getText().toString(),
